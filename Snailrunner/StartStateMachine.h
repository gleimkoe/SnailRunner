...
public:
	...
	enum class State { FAILURE, START, SUCHEN, AUSRICHTEN, LAMPE_STOP, CORRECT_TRAIL_LEFT, CORRECT_TRAIL_RIGHT, ON_TRAIL, OFF_TRAIL, STOPPING, FINAL };
	enum class Event { WALL_AHEAD, NOT_WALL_AHEAD, OFF_TRAIL, ON_TRAIL, ECKEN_CNT, IS_STOPPED};
